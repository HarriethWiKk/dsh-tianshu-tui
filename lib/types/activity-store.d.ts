 ...
 */
export declare function projectActivity(state: ActivityState, id: string, now: number, toolUseCount?: number): ActivityItem | undefined;
/**
 * 按 id 合并多组条目：label 保留首个出现值，其余字段后续覆盖/填补；顺序保持。
 * @param groups - 多组条目（按组内、跨组顺序遍历）。
 * @returns 合并去重后的条目，按首次出现顺序。
 */
export declare function mergeActivityItems(groups: readonly (readonly ActivityItem[])[]): ActivityItem[];
