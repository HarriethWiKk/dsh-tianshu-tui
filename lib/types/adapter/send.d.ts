 ...
 */
export declare function controlsFromHandle(handle: AgentHandle): AgentControls;
/**
 ...
 */
export declare function controlsFromAgent(agent: Agent): AgentControls;
/**
 ...
 */
export declare function controlsFromRegistry(ctx: Context, id: SessionId): AgentControls | undefined;
