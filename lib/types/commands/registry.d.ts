 ...
 */
export declare const BUILTIN_COMMAND_NAMES: readonly ["theme", "session", "fork", "branch", "clear", "compact", "steer", "model", "effort", "tasks", "density", "goal", "status", "subagents", "workflow", "config", "skills", "rewind", "btw", "doctor", "mcp", "remember", "memory", "export"];
/**
