...
import { takeChildStats } from '../ui/activity-flow.js';
import type { DelegationProgressProjection, DelegationTreeEntry, ExternalRunEntry } from '../delegation-panel.js';
...
export interface SubagentSubscribe {
    (event: 'subagent/start', cb: (info: {
        runId: string;
        id: string;
    }) => void): () => void;
    (event: 'subagent/end', cb: (info: {
        runId: string;
        stopReason: string;
    }) => void): () => void;
}
...
export declare class DelegationSurfaceController {
    private readonly opts;
    private treeEntries;
    private readonly runs;
    private readonly progress;
    private externalRunEntries;
    private currentDisposer;
    constructor(opts: DelegationSurfaceOptions);
