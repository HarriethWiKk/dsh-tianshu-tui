...
export declare const LIVE_CARD_BODY_FIRST = "\u23BF  ";
/** 卡片 body 续行对齐前缀（三空格，对齐 ⎿ 后的正文列）。 */
export declare const LIVE_CARD_BODY_CONT = "   ";
 ...
 */
export declare function liveCardGlyph(status: LiveCardStatus, opts?: LiveCardGlyphOptions): string;
 ...
 */
export declare function formatLiveCard(input: FormatLiveCardInput): string[];
/**
 ...
 * @returns 带前缀的 body 行。
 */
export declare function indentLiveCardBody(bodyLines: readonly string[], indent: string, theme?: RivetTheme, width?: number): string[];
/**
 ...
 */
export declare function assembleLiveCardSuffixes(line: string, suffixes: readonly string[], width: number): string;
/**
 ...
 */
export declare function truncateToLiveWidth(text: string, max: number): string;
