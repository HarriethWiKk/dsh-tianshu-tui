 ...
 */
export declare function resolvePresetId(headerAgentPreset: string | undefined, events: readonly SessionEvent[] | undefined): string | undefined;
/**
 ...
 */
export declare function wireToolNames(events: readonly SessionEvent[] | undefined): readonly string[] | undefined;
/**
 * wire 工具面的展示文本：`[bash, str_replace_editor]` 形式。
 * @param names - wireToolNames 的输出。
 * @returns 方括号列表文本；undefined → undefined。
 */
export declare function formatWireSurface(names: readonly string[] | undefined): string | undefined;
/**
 ...
 */
export declare function wirePhaseLabel(names: readonly string[] | undefined): string | undefined;
